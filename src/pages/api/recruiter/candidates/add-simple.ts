...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const skills = getName(fields.skills);
    ...
    console.log("Critical fields:", { fullName, email, profileAllocationId });
    ...
    console.log("Converted to array:", skillsArray);
    ...
    // Make sure the feedback data is properly formatted and all fields are included
    const cleanedAdditionalData = {
      ...
      numberOfDirectReportees: numberOfDirectReportees || '',
    ...
    // Log the feedback data that will be stored
    console.log('Feedback data to be stored:', cleanedAdditionalData);
    
    const feedbackJson = JSON.stringify(cleanedAdditionalData);
    console.log('Feedback JSON to be stored:', feedbackJson);
    
    const recruiterCandidate = await prisma.recruiter_candidates.create({
      data: {
        id: uuidv4(),
    ...
    console.log(`Stored feedback data: ${recruiterCandidate.feedback}`);
